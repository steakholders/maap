      ...
      return this.each(function() {
        ...
        $tips.each(function(idx) {
          ...
          $target.popover({
            ...
            content: "<p style=\"height:100px\">" + ($li.html()) + "</p><p style=\"text-align: right\"><a href=\"#/"+settings.current_path+"\" class=\"tour-tip-next btn btn-success\" eat-click data-touridx=\"" + (idx + 1) + "\">" + ((idx + 1) < $tips.length ? 'Next <i class="icon-chevron-right icon-white"></i>' : '<i class="icon-ok icon-white"></i> Done') + "</a></p>",
        ...
        return $(document).on('click', 'a.tour-tip-next', function(e) {
          e.preventDefault();
